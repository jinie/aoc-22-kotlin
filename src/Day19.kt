/*
Solution borrowed from https://github.com/tginsberg/advent-2022-kotlin/blob/main/src/main/kotlin/com/ginsberg/advent2022/Day19.kt
 */
...
fun main() {
    ...
    check(Day19(testInput).solvePart1() == 33)

    measureTimeMillisPrint {
        val input = readInput("Day19")
        val d19 = Day19(input)
        println(d19.solvePart1())
        println(d19.solvePart2())
    }
}